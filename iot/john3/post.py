...
args.message = {"timestamp": str(time.time()), "sensor_id": "3", "sensor_type": "CLOUD-3", "smoke_sensor": str(randint(0,1)), "sensor_model": str(str(randint(0, 100))), "responsible_person": str(randint(0, 100))}
